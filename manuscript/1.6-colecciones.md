...
* Para usar la estructura de datos tenemos que saber cosas sobre ella, como que es un array. Pero podría ser un diccionario, una lista enlazada, un conjunto, etc. Si accedemos a la estructura de datos directamente, estamos acoplando el código que la usa a la estructura de datos concreta. Es un caso de _Innapropriate Intimacy_.
